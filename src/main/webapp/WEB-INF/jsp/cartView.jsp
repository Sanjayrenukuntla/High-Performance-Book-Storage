   ...
   <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-3 bookview" style="margin-top: 10px;" >
        <img src="/images/${element.bookModel.bookUrl}" class="img" alt="image">
       
        <p>Book Name: ${element.bookModel.bookName}</p>
        <p>Book IsN :${element.bookModel.bookIsn}</p>
        <p>Author Name : ${element.bookModel.authorModel.authorName}</p>
        <p>Publisher Name : ${element.bookModel.publisherModel.publisherName}</p>
        ...
        <p>The cart is empty</p>
         ...
         <c:otherwise>
            <form action="/paymentpage" method="get">
                ...
                <input type="submit" value="Buy The books" class="btn btn-danger" style="margin: 20px 20px; padding: 20px 20px"/> 
            </form> 
         </c:otherwise>
      </c:choose>
